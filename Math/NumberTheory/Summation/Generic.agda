...
-- agda-misc
open import Math.NumberTheory.Summation.Generic.Base

module MonoidSummation {c e} (M : Monoid c e) where
  open MonoidSummationBase M public
  open Monoid M
...
module CommutativeMonoidSummation
  {c e} (CM : CommutativeMonoid c e) where
  open CommutativeMonoid CM
  open MonoidSummation monoid public
...
module SemiringSummation {c e} (SR : Semiring c e) where
  open Semiring SR
  open CommutativeMonoidSummation +-commutativeMonoid public
  open SetoidReasoning setoid
